...
div_add_plus_img
                        */
                        ...
                        setTimeout(function(){ 
                            ...
                            if(img_cookie_add==true){
                                    var ok = new Information("add_img_log.php"); // création de la classe 
                                    ok.add("log_user_sha1", document.getElementById("title_first").title); // ajout de l'information pour lenvoi 
                                    ...
                                    Ajax("add_img2","img_cookie.php");
                            }
                            else {
                                var ok = new Information("add_img_log2.php"); // création de la classe 
                                ok.add("log_user_sha1", "k"); // ajout de l'information pour lenvoi 
                                
                                console.log(ok.info()); // demande l'information dans le tableau
                                ok.push(); // envoie l'information au code pkp 

                                Ajax("div_add_plus","img_cookie.php");
